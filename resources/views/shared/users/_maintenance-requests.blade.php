@forelse ($maintenanceRequests as $request)
	<a href="{{ $request->type ? route('maintenance.edit', $request->id) : route('maintenance.editPost', $request->id)  }}" class="list-group-item list-group-item-action flex-column align-items-start">
